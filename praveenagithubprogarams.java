...
public class praveenagithubprogarams {  
	...
	public static void main(String[] args) throws IOException  {
		...
		int k1=s.nextInt();
		    int result1=minDiff(arr, n, k);  
		    System.out.println("Number of the employees:"+k); 
		    int startindex1=findele(result,arr,n,k);
		    System.out.println("Here the goodies that are selected for distribution are:");
		    for(int i=startindex;i<startindex+k;i++)
		    System.out.println(items[i]);
		      System.out.println("And the difference between the chosen goodie with highest price and the lowest price is:"+result);
		      System.out.println("Enter the number of employees");
			    ...
			    int k2=s.nextInt();
			    int result2=minDiff(arr, n, k);  
			    System.out.println("Number of the employees:"+k); 
			    int startindex2=findele(result,arr,n,k);
			    System.out.println("Here the goodies that are selected for distribution are:");
			    for(int i=startindex;i<startindex+k;i++)
			    System.out.println(items[i]);
			      System.out.println("And the difference between the chosen goodie with highest price and the lowest price is:"+result);
			      System.out.println("Enter the number of employees");
				    ...
				    int k3=s.nextInt();
				    int result3=minDiff(arr, n, k);  
				    System.out.println("Number of the employees:"+k); 
				    int startindex3=findele(result,arr,n,k);
				    System.out.println("Here the goodies that are selected for distribution are:");
				    for(int i=startindex;i<startindex+k;i++)
				    System.out.println(items[i]);
				      System.out.println("And the difference between the chosen goodie with highest price and the lowest price is:"+result);
